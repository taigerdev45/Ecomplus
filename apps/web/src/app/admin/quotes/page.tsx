      ...
      <div className="space-y-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button className="rounded-xl border border-slate-200 bg-white p-2 text-slate-600 hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900">
                ...
                <tr key={quote.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-2">
                      <button className="rounded-lg p-2 text-slate-400 hover:bg-slate-100 hover:text-primary dark:hover:bg-slate-800" title="Voir PDF">
                        <FileText className="h-4 w-4" />
                      </button>
                      <button className="rounded-lg p-2 text-slate-400 hover:bg-slate-100 hover:text-green-600 dark:hover:bg-slate-800" title="Renvoyer WhatsApp">
          ...
          {filteredQuotes.map((quote) => (
            <div key={quote.id} className="rounded-2xl bg-white p-5 shadow-sm dark:bg-slate-900">
              ...
              <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
                ...
                <div className="flex gap-2">
                  <button className="rounded-lg bg-slate-100 p-2 text-slate-600 dark:bg-slate-800">
                    <FileText className="h-4 w-4" />
                  </button>
                  <button className="rounded-lg bg-green-50 p-2 text-green-600 dark:bg-green-900/20">
                    <MessageCircle className="h-4 w-4" />
                  </button>
                </div>
              </div>
