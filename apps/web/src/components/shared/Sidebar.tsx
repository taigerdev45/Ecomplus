...
export default function Sidebar({ isOpen, onClose, sections, portalLabel }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* ——— Sidebar Drawer ——— */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-72 flex-col bg-white shadow-2xl transition-transform duration-300 ease-in-out dark:bg-slate-900 lg:translate-x-0 lg:shadow-none lg:border-r lg:border-slate-200/70 dark:lg:border-slate-800/70 ${
